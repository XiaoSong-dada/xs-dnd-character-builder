...
export const magicItemsCatalog2014: readonly EquipmentRule[] = [
    ...
    },
    {
      ...
      "ruleset": "5e-2014",
      "status": "selectable",
      "description": "射向持盾者 5 尺内目标的远程攻击，命中时改射向持盾者。",
      "classIds": [],
      "equippable": true,
      "category": "armor",
      "rarity": "rare",
    ...
    },
    {
      ...
      "ruleset": "5e-2014",
      "status": "selectable",
      "description": "内部空间约 64 立方尺/500 磅，袋重不随内容增加。",
      "classIds": [],
      "equippable": true,
      "category": "magic",
      "rarity": "uncommon",
    ...
    },
    {
      ...
      "ruleset": "5e-2014",
      "status": "selectable",
      "description": "掷出后爆炸成力场球，困住 10 尺内目标 1 分钟。",
      "classIds": [],
      "equippable": true,
      "category": "magic",
      "rarity": "rare",
    ...
    },
    {
      ...
      "ruleset": "5e-2014",
      "status": "selectable",
      "description": "可骑乘飞行的扫帚，速度 50 尺，最多载 400 磅。",
      "classIds": [],
      "equippable": true,
      "category": "magic",
      "rarity": "uncommon",
    ...
    },
    {
      ...
      "ruleset": "5e-2014",
      "status": "selectable",
      "description": "每日 3 次对 30 尺内生物施放魅惑术（豁免 DC 13）。",
      "classIds": [],
      "equippable": true,
      "category": "magic",
      "rarity": "uncommon",
    ...
    },
    {
      ...
      "ruleset": "5e-2014",
      "status": "selectable",
      "description": "施放侦测思想；可与 120 尺内生物心灵交流。",
      "classIds": [],
      "equippable": true,
      "category": "magic",
      "rarity": "uncommon",
    ...
    },
    {
      ...
      "ruleset": "5e-2014",
      "status": "selectable",
      "description": "吹响发出爆音，30 尺内生物受音波伤害；有反震自伤风险。",
      "classIds": [],
      "equippable": true,
      "category": "magic",
      "rarity": "rare",
    ...
    },
    {
      ...
      "ruleset": "5e-2014",
      "status": "selectable",
      "description": "命令后 30 尺内生物恐惧（豁免 DC 15），持续 1 分钟。",
      "classIds": [],
      "equippable": true,
      "category": "weapon",
      "rarity": "rare",
    ...
    },
    {
      ...
      "ruleset": "5e-2014",
      "status": "selectable",
      "description": "吹奏令 30 尺内生物恐惧（豁免 DC 15）。",
      "classIds": [],
      "equippable": true,
      "category": "magic",
      "rarity": "uncommon",
    ...
    },
    {
      ...
      "ruleset": "5e-2014",
      "status": "selectable",
      "description": "展开成直径 6 尺、深 8 尺的次元空间布，可收纳大量物品。",
      "classIds": [],
      "equippable": true,
      "category": "magic",
      "rarity": "rare",
    ...
    },
    {
      ...
      "ruleset": "5e-2014",
      "status": "selectable",
      "description": "透视 30 尺内物质；每使用 1 分钟获得 1 级力竭。",
      "classIds": [],
      "equippable": true,
      "category": "magic",
      "rarity": "rare",
    ...
    },
    {
      ...
      "ruleset": "5e-2014",
      "status": "selectable",
      "description": "展开后在 30 尺内形成防护光环，阻止特定类型生物进入。",
      "classIds": [],
      "equippable": true,
      "category": "magic",
      "rarity": "rare",
    ...
    },
    {
      ...
      "ruleset": "5e-2014",
      "status": "selectable",
      "description": "直径 2 尺的黑色球体，吞噬一切接触之物，极难控制。",
      "classIds": [],
      "equippable": true,
      "category": "magic",
      "rarity": "legendary",
    ...
    },
    {
      ...
      "ruleset": "5e-2014",
      "status": "selectable",
      "description": "10 分钟内侦测 60 尺内怀有敌意的生物。",
      "classIds": [],
      "equippable": true,
      "category": "magic",
      "rarity": "rare",
