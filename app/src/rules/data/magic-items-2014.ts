...
export const magicItems2014: readonly EquipmentRule[] = [
  ...
  m({ id: 'javelin-of-lightning', name: '闪电标枪', description: '掷出时可化为闪电束：目标与直线上 50 尺内生物各受 4d6 闪电伤害。化雷后次日黎明恢复。', category: 'weapon', equippable: true, rarity: 'uncommon', weaponKind: 'simple-melee', damageDice: '1d6', damageType: '穿刺' }),
  ...
  wonder('bag-of-holding', '次元袋', '袋内空间约 64 立方尺、载重 500 磅，外观与普通袋子无异。放入超过容量或活物可能导致袋体撕裂。', 'uncommon', false),
  ...
  wonder('boots-of-striding-and-springing', '跳跑之靴', '步行速度提升至 30 尺，跳跃距离增至三倍；不受负重与重甲的速度限制。', 'uncommon', true),
  ...
  wonder('broom-of-flying', '飞天扫帚', '同调后可骑乘扫帚飞行，速度 50 尺（负载不超过 400 磅）；可悬停与按口令行动。', 'uncommon', true, true),
  ...
  wonder('cloak-of-the-manta-ray', '蝠鲼斗篷', '披上后可在水下呼吸，并获得 60 尺游泳速度。', 'uncommon', true),
  ...
  wonder('dust-of-disappearance', '消失粉尘', '洒出后，粉尘周围 10 尺内的生物与物体隐形 2d4 分钟。', 'uncommon', false),
  wonder('dust-of-dryness', '干燥粉尘', '吸收大片水域凝结成可携带的珠粒，掷出可再释放水；具体吸收量与伤害效果以《城主指南》为准。', 'uncommon', false),
  ...
  wonder('helm-of-telepathy', '心灵感应头盔', '同调后可探测思想（每日次数），并可向 30 尺内生物发送心灵感应讯息。', 'uncommon', true, true),
  wonder('keoghtoms-ointment', '凯托姆药膏', '药膏 1 剂可治愈疾病与毒素，或恢复 2d8+2 点生命值；每日共 2 剂。', 'uncommon', false),
  wonder('lantern-of-revealing', '显形提灯', '点燃后，半径 30 尺内隐形的生物与物体显形（轮廓可见）。', 'uncommon', false),
  ...
  wonder('pipes-of-haunting', '慑魂风笛', '吹奏可使 30 尺内听到的敌人恐惧（感知豁免 DC 15），持续 1 分钟。', 'uncommon', false),
  wonder('pipes-of-the-sewers', '下水道风笛', '吹奏可吸引 30 尺内的老鼠与巨鼠，并通过魅力检定指挥它们。', 'uncommon', false),
  wonder('robe-of-useful-items', '实用物品袍', '袍上缝有魔法补丁，撕下可变成实用物品：铁梯、火把、麻袋、狗、镜、绳梯、水袋、木箱等。', 'uncommon', true),
  wonder('rope-of-climbing', '攀爬绳', '按口令可自行攀附墙面、打结、伸长（最长 60 尺）并固定。', 'uncommon', false),
  ...
  wonder('winged-boots', '飞翼之靴', '同调后获得 30 尺飞行速度，可悬停；每日飞行总时长 4 小时。', 'uncommon', true, true),
  ...
  wonder('wand-of-secrets', '秘钥魔杖', '用魔杖触碰可揭示附近 30 尺内的暗门与隐藏物（每日次数有限）。', 'uncommon', false),
  ...
  wonder('ring-of-swimming', '游泳戒指', '穿戴后获得 40 尺游泳速度。', 'uncommon', true),
