...
export const fighterOptions: readonly RuleOption[] = [
  ...
  { id: 'maneuver-precision', name: '精准攻击', englishName: 'Precision Attack', description: '武器攻击检定掷出后、结果宣布前，消耗 1 颗优势骰加到该攻击检定上。', status: 'implemented', sourceIds: ['phb-2014-index'] },
  { id: 'maneuver-trip', name: '绊摔攻击', englishName: 'Trip Attack', description: '武器命中目标时消耗 1 颗优势骰，附加骰值伤害；目标力量豁免失败则倒地。', status: 'implemented', sourceIds: ['phb-2014-index'] },
  { id: 'maneuver-rally', name: '激励集结', englishName: 'Rally', description: '以附赠动作消耗 1 颗优势骰，为 30 尺内一名盟友提供临时生命（骰值 + 魅力调整值）。', status: 'implemented', sourceIds: ['phb-2014-index'] },
  { id: 'maneuver-menacing', name: '恐吓攻击', englishName: 'Menacing Attack', description: '武器命中时消耗 1 颗优势骰，附加骰值伤害；目标感知豁免失败则恐惧你，持续至你的下回合结束。', status: 'implemented', sourceIds: ['phb-2014-index'] },
  { id: 'maneuver-riposte', name: '还击', englishName: 'Riposte', description: '被近战攻击未命中时，以反应消耗 1 颗优势骰，对攻击者进行一次近战武器攻击，命中附加骰值伤害。', status: 'implemented', sourceIds: ['phb-2014-index'] },
  { id: 'maneuver-pushing', name: '推撞攻击', englishName: 'Pushing Attack', description: '武器命中时消耗 1 颗优势骰，附加骰值伤害；目标力量豁免失败则被推离 15 尺。', status: 'implemented', sourceIds: ['phb-2014-index'] },
  { id: 'maneuver-disarming', name: '缴械攻击', englishName: 'Disarming Attack', description: '武器命中时消耗 1 颗优势骰，附加骰值伤害；目标力量豁免失败则手中一件武器或物品脱手，落在脚边。', status: 'implemented', sourceIds: ['phb-2014-index'] },
  { id: 'maneuver-commanders-strike', name: '指挥官突袭', englishName: "Commander's Strike", description: '攻击动作中放弃一次攻击，以附赠动作消耗 1 颗优势骰，指定一名盟友用反应发动一次武器攻击，命中附加骰值伤害。', status: 'implemented', sourceIds: ['phb-2014-index'] },
  { id: 'maneuver-goading', name: '挑衅攻击', englishName: 'Goading Attack', description: '武器命中时消耗 1 颗优势骰，附加骰值伤害；目标对你以外的目标发动攻击检定时具有劣势，持续至你的下回合结束。', status: 'implemented', sourceIds: ['phb-2014-index'] },
  { id: 'maneuver-maneuvering', name: '机动攻击', englishName: 'Maneuvering Attack', description: '武器命中时消耗 1 颗优势骰，附加骰值伤害；随后一名盟友可无借机攻击地移动至多一半速度。', status: 'implemented', sourceIds: ['phb-2014-index'] },
  { id: 'maneuver-sweeping', name: '横扫攻击', englishName: 'Sweeping Attack', description: '武器命中时消耗 1 颗优势骰，附加骰值伤害；对 5 尺内另一目标造成等值骰面伤害（不附加其他效果）。', status: 'implemented', sourceIds: ['phb-2014-index'] },
]
...
export const fighterRule: ClassRule = {
  ...
  checkpoints: [
    ...
    { id: 'fighter-2014-subclass-3', level: 3, step: 'timeline', kind: 'subclass', title: '选择武术范型', description: '纵向切片实现战斗大师。', required: true, minSelections: 1, maxSelections: 1, optionIds: [], optionPresentation: 'expandable' as const },
