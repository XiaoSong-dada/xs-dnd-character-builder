...
export const fighterOptions: readonly RuleOption[] = [
  ...
  { id: 'maneuver-rally', name: '激励集结', englishName: 'Rally', description: '以附赠动作消耗 1 颗优势骰，为 9 米内一名盟友提供临时生命（骰值 + 魅力调整值）。', status: 'implemented', sourceIds: ['phb-2014-index'] },
  ...
  { id: 'maneuver-pushing', name: '推撞攻击', englishName: 'Pushing Attack', description: '武器命中时消耗 1 颗优势骰，附加骰值伤害；目标力量豁免失败则被推离 4.5 米。', status: 'implemented', sourceIds: ['phb-2014-index'] },
  ...
  { id: 'maneuver-sweeping', name: '横扫攻击', englishName: 'Sweeping Attack', description: '武器命中时消耗 1 颗优势骰，附加骰值伤害；对 1.5 米内另一目标造成等值骰面伤害（不附加其他效果）。', status: 'implemented', sourceIds: ['phb-2014-index'] },
]
...
export const fighterRule: ClassRule = {
  ...
  checkpoints: [
    ...
    { id: 'fighter-2014-subclass-3', level: 3, step: 'timeline', kind: 'subclass', title: '选择武术范型', description: '纵向切片实现战斗大师。', required: true, minSelections: 1, maxSelections: 1, optionIds: [] },
