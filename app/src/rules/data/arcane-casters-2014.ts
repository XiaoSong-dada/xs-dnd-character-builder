...
export const arcaneCasterClasses2014: readonly ClassRule[] = [
  {
    ...
    checkpoints: [
      ...
      { id: 'wizard-2014-subclass-2', level: 2, step: 'timeline', kind: 'subclass', title: '选择奥术传承', description: '奥术传统在2级确定。', required: true, minSelections: 1, maxSelections: 1, optionIds: wizardSubclassIds, optionPresentation: 'expandable' as const },
