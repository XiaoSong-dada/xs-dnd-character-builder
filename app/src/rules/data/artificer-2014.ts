...
export const artificerClass2014: ClassRule = {
  ...
  checkpoints: [
    ...
    { id: 'artificer-2014-subclass-3', level: 3, step: 'timeline', kind: 'subclass', title: '选择奇械师专职', description: '在炼金师、装甲师、魔炮师与战地匠师中选择。', required: true, minSelections: 1, maxSelections: 1, optionIds: [], optionPresentation: 'expandable' as const },
