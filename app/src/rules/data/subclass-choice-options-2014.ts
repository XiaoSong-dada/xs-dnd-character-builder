...
export const subclassChoiceOptions2014: readonly RuleOption[] = [
  ...
  { id: 'totem-eagle', name: '鹰', englishName: 'Eagle', description: '狂暴期间，感知（察觉）检定具有优势，并可看清 1 里外的景象。', status: 'implemented', sourceIds: phb },
  { id: 'totem-wolf', name: '狼', englishName: 'Wolf', description: '狂暴期间，对 5 尺内至少一名盟友正在围攻的目标发动近战攻击时具有优势。', status: 'implemented', sourceIds: phb },
  ...
  { id: 'hunter-prey-horde-breaker', name: '破阵者', englishName: 'Horde Breaker', description: '攻击动作中命中目标后，可对 5 尺内另一生物再发动一次攻击（每回合一次）。', status: 'implemented', sourceIds: phb },
  ...
  { id: 'hunter-multiattack-volley', name: '齐射', englishName: 'Volley', description: '攻击动作中，对 10 尺半径内可见的生物各进行一次远程武器攻击。', status: 'implemented', sourceIds: phb },
  { id: 'hunter-multiattack-whirlwind', name: '旋风攻击', englishName: 'Whirlwind Attack', description: '攻击动作中，对 5 尺内所有可见的生物各进行一次近战武器攻击。', status: 'implemented', sourceIds: phb },
  ...
  // ============ 龙族祖先（PHB 2014，龙族血脉） ============
  { id: 'dragon-black', name: '黑龙', englishName: 'Black Dragon', description: '选择黑龙祖先：获得强酸伤害抗性并能说龙语；3 级起获得吐息武器（5×5 尺线形强酸吐息，2d6 伤害，敏捷豁免减半，长休后恢复）。', status: 'implemented', sourceIds: phb },
  { id: 'dragon-blue', name: '蓝龙', englishName: 'Blue Dragon', description: '选择蓝龙祖先：获得闪电伤害抗性并能说龙语；3 级起获得吐息武器（5×5 尺线形闪电吐息，2d6 伤害，敏捷豁免减半，长休后恢复）。', status: 'implemented', sourceIds: phb },
  { id: 'dragon-green', name: '绿龙', englishName: 'Green Dragon', description: '选择绿龙祖先：获得毒素伤害抗性并能说龙语；3 级起获得吐息武器（15 尺锥形毒气吐息，2d6 伤害，体质豁免减半，长休后恢复）。', status: 'implemented', sourceIds: phb },
  { id: 'dragon-red', name: '红龙', englishName: 'Red Dragon', description: '选择红龙祖先：获得火焰伤害抗性并能说龙语；3 级起获得吐息武器（15 尺锥形火焰吐息，2d6 伤害，敏捷豁免减半，长休后恢复）。', status: 'implemented', sourceIds: phb },
  { id: 'dragon-white', name: '白龙', englishName: 'White Dragon', description: '选择白龙祖先：获得冷冻伤害抗性并能说龙语；3 级起获得吐息武器（15 尺锥形寒冰吐息，2d6 伤害，体质豁免减半，长休后恢复）。', status: 'implemented', sourceIds: phb },
  { id: 'dragon-brass', name: '黄铜龙', englishName: 'Brass Dragon', description: '选择黄铜龙祖先：获得火焰伤害抗性并能说龙语；3 级起获得吐息武器（5×5 尺线形火焰吐息，2d6 伤害，敏捷豁免减半，长休后恢复）。', status: 'implemented', sourceIds: phb },
  { id: 'dragon-bronze', name: '青铜龙', englishName: 'Bronze Dragon', description: '选择青铜龙祖先：获得闪电伤害抗性并能说龙语；3 级起获得吐息武器（5×5 尺线形闪电吐息，2d6 伤害，敏捷豁免减半，长休后恢复）。', status: 'implemented', sourceIds: phb },
  { id: 'dragon-copper', name: '铜龙', englishName: 'Copper Dragon', description: '选择铜龙祖先：获得强酸伤害抗性并能说龙语；3 级起获得吐息武器（5×5 尺线形强酸吐息，2d6 伤害，敏捷豁免减半，长休后恢复）。', status: 'implemented', sourceIds: phb },
  { id: 'dragon-gold', name: '金龙', englishName: 'Gold Dragon', description: '选择金龙祖先：获得火焰伤害抗性并能说龙语；3 级起获得吐息武器（15 尺锥形火焰吐息，2d6 伤害，敏捷豁免减半，长休后恢复）。', status: 'implemented', sourceIds: phb },
  { id: 'dragon-silver', name: '银龙', englishName: 'Silver Dragon', description: '选择银龙祖先：获得冷冻伤害抗性并能说龙语；3 级起获得吐息武器（15 尺锥形寒冰吐息，2d6 伤害，体质豁免减半，长休后恢复）。', status: 'implemented', sourceIds: phb },
  ...
  { id: 'beast-form-tail', name: '野兽之尾', englishName: 'Tail', description: '狂暴期间长出长尾：徒手攻击伤害 1d8 钝击、触及 10 尺；被攻击命中时可用反应使护甲等级 +1d8。', status: 'implemented', sourceIds: xgte },

  // ============ 巨人力量（BGG，巨人道途） ============
  { id: 'giant-power-cloud', name: '云巨人', englishName: 'Cloud Giant', description: '狂暴期间可用附赠动作向 10 尺内喷出毒云：目标体质豁免失败则陷入中毒 1 轮（每回合一次）。', status: 'implemented', sourceIds: bigby },
  { id: 'giant-power-fire', name: '火巨人', englishName: 'Fire Giant', description: '狂暴期间可用附赠动作点燃 5 尺内一名生物：敏捷豁免失败则受 1d10 火焰伤害（每回合一次）。', status: 'implemented', sourceIds: bigby },
  { id: 'giant-power-frost', name: '霜巨人', englishName: 'Frost Giant', description: '狂暴期间可用附赠动作冻结面前 15 尺锥形地面：力量豁免失败的生物倒地（每回合一次）。', status: 'implemented', sourceIds: bigby },
  { id: 'giant-power-hill', name: '山丘巨人', englishName: 'Hill Giant', description: '狂暴期间跳跃距离提升，落地时可用附赠动作震慑 10 尺内生物（体质豁免，每回合一次）。', status: 'implemented', sourceIds: bigby },
  ...
  { id: 'giant-power-storm', name: '风暴巨人', englishName: 'Storm Giant', description: '被 30 尺内生物攻击命中时，可用反应使其受 1d10 雷鸣伤害（每回合一次）。', status: 'implemented', sourceIds: bigby },

  // ============ 风暴光环（XGtE，风暴先驱道途） ============
  { id: 'storm-aura-desert', name: '沙漠', englishName: 'Desert', description: '狂暴期间回合开始时，10 尺内其他生物敏捷豁免失败则受 2 点火焰伤害（成功减半），豁免 DC 同狂暴触发值。', status: 'implemented', sourceIds: xgte },
  { id: 'storm-aura-sea', name: '海洋', englishName: 'Sea', description: '狂暴期间可用附赠动作，迫使 5 尺内一名生物敏捷豁免失败则受 1d6 闪电或雷鸣伤害（自选）。', status: 'implemented', sourceIds: xgte },
  { id: 'storm-aura-tundra', name: '苔原', englishName: 'Tundra', description: '狂暴期间可用附赠动作，使 10 尺内其他生物各获得 2 点临时生命。', status: 'implemented', sourceIds: xgte },

  // ============ 精魂图腾（XGtE，牧人结社） ============
  { id: 'spirit-totem-bear', name: '熊', englishName: 'Bear Spirit', description: '召唤熊精魂守护 30 尺内盟友：范围内你与盟友每回合开始时获得等于德鲁伊等级的临时生命。', status: 'implemented', sourceIds: xgte },
  { id: 'spirit-totem-eagle', name: '鹰', englishName: 'Eagle Spirit', description: '召唤鹰精魂：你获得 60 尺飞行速度；30 尺内盟友对 30 尺外可见生物的攻击检定具有优势。', status: 'implemented', sourceIds: xgte },
  { id: 'spirit-totem-unicorn', name: '独角兽', englishName: 'Unicorn Spirit', description: '召唤独角兽精魂：你施放治疗法术后，30 尺内一名生物额外恢复等于德鲁伊等级的生命值。', status: 'implemented', sourceIds: xgte },
  ...
  { id: 'starry-form-chalice', name: '圣杯', englishName: 'Chalice', description: '星图形态-圣杯：你施放治疗法术后掷 1d8，让 30 尺内一名生物额外恢复等量生命值。', status: 'implemented', sourceIds: tcoe },
  { id: 'starry-form-dragon', name: '飞龙', englishName: 'Dragon', description: '星图形态-飞龙：智力检定与维持专注的豁免具有优势；30 尺内敌人对你维持专注的豁免具有劣势。', status: 'implemented', sourceIds: tcoe },
  ...
  { id: 'arcane-shot-bursting', name: '爆裂箭', englishName: 'Bursting Arrow', description: '箭矢命中后额外 2d6 力场伤害；5 尺内其他生物敏捷豁免失败则各受 2d6 力场伤害。', status: 'implemented', sourceIds: xgte },
  ...
  { id: 'arcane-shot-grasping', name: '缠绕箭', englishName: 'Grasping Arrow', description: '箭矢命中后额外 2d6 穿刺伤害；目标被荆棘缠绕，移动时每 5 尺受 1d6 穿刺，可用动作以力量检定挣脱。', status: 'implemented', sourceIds: xgte },
  { id: 'arcane-shot-piercing', name: '贯穿箭', englishName: 'Piercing Arrow', description: '射出 5 尺宽 90 尺长的箭幕：范围内生物敏捷豁免失败则受 2d6 穿刺伤害（成功减半）。', status: 'implemented', sourceIds: xgte },
  ...
  // ============ 符文雕刻者（TCoE，符文骑士） ============
  { id: 'rune-cloud', name: '云符文', englishName: 'Cloud Rune', description: '雕刻后获得：你或 30 尺内可见生物被攻击命中时，可用反应将该次攻击重定向至 30 尺内另一生物。', status: 'implemented', sourceIds: tcoe },
  ...
  { id: 'rune-frost', name: '霜符文', englishName: 'Frost Rune', description: '雕刻后威吓与驯兽检定优势；可激活冰之凝视，30 尺内一名生物力量豁免失败则受 2d6 冷冻并被束缚 10 分钟。', status: 'implemented', sourceIds: tcoe },
  ...
  { id: 'rune-stone', name: '石符文', englishName: 'Stone Rune', description: '雕刻后洞察检定优势；激活后 30 尺内生物免疫魅惑与恐慌，且对你发动的感知检定具有劣势。', status: 'implemented', sourceIds: tcoe },
  ...
  // ============ 元素纪律（PHB 2014，四象宗） ============
  { id: 'discipline-fangs-of-fire', name: '火之獠牙', englishName: 'Fangs of the Fire Snake', description: '消耗气点：徒手攻击造成火焰伤害（1d10），触及 +10 尺；命中后可用附赠动作追加 1d10 火焰伤害。', status: 'implemented', sourceIds: phb },
  { id: 'discipline-fist-of-four-thunders', name: '四雷之拳', englishName: 'Fist of Four Thunders', description: '消耗气点：拳头迸发雷鸣冲击，10 尺内生物力量豁免失败则被推离 10 尺并受雷鸣伤害。', status: 'implemented', sourceIds: phb },
  ...
  { id: 'discipline-sweeping-cinder', name: '横扫余烬', englishName: 'Sweeping Cinder Strike', description: '消耗气点：近战攻击命中后横扫余烬，5 尺内另一生物敏捷豁免失败则受火焰伤害。', status: 'implemented', sourceIds: phb },
  { id: 'discipline-wave-of-rolling-earth', name: '滚土之波', englishName: 'Wave of Rolling Earth', description: '消耗气点：近战攻击命中后地面涌动，30 尺线内生物力量豁免失败则倒地。', status: 'implemented', sourceIds: phb },
