...
export const magicItemsXgteTcoe2014: readonly EquipmentRule[] = [
  ...
  xgCommon('candle-of-the-deep', '深海蜡烛', '可在水下正常燃烧的蜡烛，照亮 5 尺，不受水流影响。'),
  ...
  xgCommon('moon-touched-sword', '月光剑', '武器：在黑暗中如月光般柔和发光，照亮 15 尺（微光）。', 'weapon', true),
  ...
  xgCommon('pole-of-anging', '钓鱼竿', '可伸缩的钓鱼竿（最长 10 尺）。'),
  xgCommon('pole-of-collapsing', '折叠杆', '一个动作在 5 尺与 10 尺之间伸缩。'),
  ...
  xgCommon('talking-doll', '会说话的玩偶', '玩偶会复述附近 10 尺内刚说过的一句短语。'),
  xgCommon('tankard-of-sobriety', '清醒酒杯', '倒入杯中的液体都会变为清淡的清水。'),
  xgCommon('wand-of-conducting', '指挥魔杖', '可指挥小型表演（手势与节奏），娱乐用途。', 'magic', true),
  xgCommon('wand-of-pyrotechnics', '烟火魔杖', '可让 30 尺内的火焰爆出绚丽烟火（动作）。', 'magic', true),
  ...
  tc({ id: 'coiling-grasp-tattoo', name: '缠绕掌握刺青', description: '身体刺青：可用附赠动作发动刺青触手攻击（10 尺触及，命中造成 1d6 力场伤害并束缚）。', category: 'magic', equippable: false, rarity: 'uncommon' }),
