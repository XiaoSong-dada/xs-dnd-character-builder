...
export const rulesRepository2024 = createRulesRepository('5e-2024', {
  ...
  backgroundFeatures: [],
  options: [...abilityImprovementOptions2024, ...spellListOptions2024, ...speciesSpellAbilityOptions2024, ...feats2024, ...skillOptions2024, ...subclassOptions2024, ...barbarianOptions2024],
  feats: feats2024,
