...
const sources = [
  ...
  { id: 'eepc-2015-index', title: '元素邪恶玩家伴侣索引', ruleset: '5e-2014' as const, url: 'https://media.wizards.com/2015/downloads/dnd/EE_PlayersCompanion.pdf' },
  { id: 'scag-2015-index', title: '剑湾冒险者指南索引', ruleset: '5e-2014' as const },
  { id: 'vgm-2016-index', title: '沃罗的怪物指南索引', ruleset: '5e-2014' as const },
  { id: 'tortle-2017-index', title: '龟人包索引', ruleset: '5e-2014' as const, url: 'https://www.dndbeyond.com/sources/tortle' },
