...
- 导出角色卡：PDF 角色卡（自绘中文打印版面，浏览器打印输出 A4）、XLSX 自动计算卡（中文工作表，含属性/技能/豁免/法术/物品与金币）、JSON 数据文件；三种导出数值与页面一致，入口在角色卡页。
- 隔离旧版 2024 草稿，保留原始数据导出能力。
- 使用赛博骰娘投掷 d4、d6、d8、d10、d12、d20 与 d100，支持混合骰池、3D 物理动画、逐颗结果和自动合计。

当前未包含多职业、2024 规则编辑、云同步和 DM 房规编辑器。“职业介绍”和“个人中心”目前为开发中占位页。
