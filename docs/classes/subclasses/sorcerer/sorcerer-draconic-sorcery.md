...
> 运行时名称采用 5e 不全书译名（龙族体魄、龙族法术、元素亲和、龙翼、龙族伙伴）；本页早期旧译名（龙族韧性、巨龙伙伴）仅作对照。
...
| 18 | 18 | 巨龙伙伴（Dragon Companion） | 龙类召唤术长休免费 1 次，也可用法术位 |
...
- 新旧同名或替代能力不得叠加；规则数据与自动化测试已由 B08-09 接入（`app/src/rules/data/sorcerer-2024.ts`，测试 `app/test/rules/sorcerer-2024.test.ts`）。
