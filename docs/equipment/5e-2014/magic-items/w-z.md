...
| 侦测魔法魔杖 | Wand of Magic Detection | 非普通 | 魔杖 | 施放侦测魔法。 | selectable |
...
| 附魔武器 +1/+2/+3 | Weapon, +1/+2/+3 | 非普通/稀有/非常稀有 | 武器 | 武器命中与伤害获得对应魔法加值。 | index-only |
| 警示武器 | Weapon of Warning | 非普通 | 武器 | 持用时提前警觉危险；先攻检定优势；睡梦中警觉。 | selectable |
| 万界之井 | Well of Many Worlds | 传说 | 奇物 | 打开通往随机位面的传送门（每日 1 次）。 | selectable |
| 风之扇 | Wind Fan | 非普通 | 奇物 | 扇出强风（可吹倒生物、吹熄火焰、推动船只）。 | selectable |
| 飞行靴 | Winged Boots | 非普通 | 奇物 | 每日 4 小时飞行，可中断续用。 | selectable |
| 飞行之翼 | Wings of Flying | 稀有 | 奇物 | 背后展开魔法翅膀，每日 2 小时飞行。 | selectable |

## X–Z

本段无独立条目（X/Y/Z 开头魔法物品不在 DMG 2014 表中；奥库斯魔杖见 `artifacts.md`）。

## 尾注

- 本段共 19 条（W 19 条）。XGtE/TCoE 补充魔法物品（常见魔法物品、刺青类）属扩展书批次，未入本表。
