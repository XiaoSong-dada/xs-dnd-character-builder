...
- 当前运行时完成度：13 个 2014 职业（含 TCoE 奇械师）与 118 个子职条目；116 个玩家子职进入时间线，2 个 DM 专用条目只作索引。2024 已完成全部 12 个基础职业、48 个核心子职与目标矩阵复核（B08-01—B08-14，60 条身份记录闭合），待 B09 受控开放。0.7.0 审计矩阵见 `source-content-matrix-0.7.0.md`。
