...
| 编号 | 任务 | 落点 | 状态 |
| --- | --- | --- | --- |
| B-01 | D2：登记 5 项候选 + 术语统一 | `subclass-choice-options-2014.ts`、`subclass-features-2014.ts` | **已完成** |
| B-02 | D4：全量盘点与判定口径结论 | 本文档第 3 节、需求 5.5 | **已完成** |
| B-03 | D1 分批一：奇械师／野蛮人／吟游诗人（4+9+8 项） | `subclasses-2014.ts` | 待办 |
| B-04 | D1 分批二：牧师／德鲁伊／战士（13+7+10 项） | 同上 | 待办 |
| B-05 | D1 分批三：武僧／圣武士／游侠（10+8+8 项） | 同上 | 待办 |
| B-06 | D1 分批四：游荡者／术士／法师（9+8+13 项） | 同上 | 待办 |
| B-07 | 文档与验证：`docs/rules.md`、需求状态、类型检查／测试／构建 | — | 待办 |
